...
from training_utils.configs import fsdp_config, train_config, gen_dataset
...
def main(**kwargs):
    ...
    update_config((train_config, fsdp_config, gen_dataset), **kwargs)
    ...
    for k in range(train_config.target_layer,train_config.target_layer+train_config.wipe_layer):
        ...
        state_dict[f'model.layers.{k}.self_attn.rotary_emb.inv_freq'].data.copy_(new_state_dict[f'model.layers.{k}.self_attn.rotary_emb.inv_freq'].data)
